...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ProbandoFechas.probar(); //la manera de llamar a una funcion estática dentro de una clase
        //probandoHerencia();
       //  herenciaVip();
    ...
    public static void probandoHerencia(){
        ...
        System.out.println("Nombre Cliente: " + invitado.getNombre()
        + " Duracion: " + invitado.getDuracionMax());
    }
    
    public static void herenciaVip(){
        ClienteVip vip = new ClienteVip(1,"laura", null);
        vip.setBeneficio("Positivo");
        System.out.println("Nombre Cliente: " + vip.getNombre()
