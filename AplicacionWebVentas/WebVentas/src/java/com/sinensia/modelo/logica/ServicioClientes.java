...
public class ServicioClientes {
    ...
    public Cliente insertar(String nombre, String email,
            String passwd, String edad, String activo) { //los datos de la web vendrían siempre en forma de cadena

        if (validar(nombre, email, passwd, edad, activo)) { //significa que validar devuelve booleano = TRUE
    ...
    public Cliente modificar(int id, String nombre, String email,
            String passwd, String edad, String activo) //throws Exception
    {
        Cliente cli = null;
